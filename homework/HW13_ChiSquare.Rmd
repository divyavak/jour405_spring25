...
A grades are 20 more than expected and Fwere 10 less than expected (30 vs. 40).
These differences could be meaningful due to differences in grading and people failing less.
...
If the chi square statistic is greater than the right tail critical value of 9.48, we can fail to reject the null hypothesis because they deviate too much from the expected grade distribution. 
...
The notable discrepancies in the expected and observed frequenceis for each grade category is especially between the A grades and C grades since more people got A's and less people got C's than expected. I would ask what changes were done to improve performances, if the material was easier or if people studied harder. 