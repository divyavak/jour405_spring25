...
Ocean City and Baltimore had the highest rates of violent crimes and over 30 cities with no crime in 2019. For property crime in 2019, Ocean City and Oakland had significantly higher rates. Ocean City had almost 70 more per capita property crimes in 2020 as well compared to Colmar Manor, the second highest. Ocean City also took over Baltimore in the violent crime category per capita in 2020. 
...
```{r}
md_cities_rates  |>
mutate(pct_changes = (property_rate_2020 - property_rate_2019) / property_rate_2019 * 100) |>
  mutate(pct_change = (violent_rate_2020 - violent_rate_2019) / violent_rate_2019 * 100) 
```
...
In just one year, the percent change between property crime is massive, between a positive and negative change, so some values were significantly higher and some drastically decreasing. In violent crime, the jump was as high as 895% in Easton which is a major outlier. 
...
Property and violent crime across Maryland cities have seen massive changes from 2019 to 2020. Ocean City has become the city with the most violent and property crime. While some cities have had little to no violent and property crimes, others like Easton saw a 895% rise. 
...
```{r}
md_cities_rates <- crime |>
  mutate((ntile = violent_rate_2020))
