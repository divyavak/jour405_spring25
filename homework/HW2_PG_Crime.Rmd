...
Some of the categories of incidents in PG County include different types of assault, theft, robbery, accidents, breaking and entering and more. Some categories like accidents and auto stolen saw significant increases in the middle and end of the year. These major shifts could be a cause of concern. Categories like assault shooting had major ups and downs which could make them hard to suammarize.
...
pg_crime_averages <- pg_crime |>
  mutate(total_incidents = Jan + Feb + Mar + Apr + May + Jun + Aug + Sep + Oct + Nov + Dec ) |>
...
Accident, stolen auto and theft from auto had the highest average number of incidents. Homicide and "B&E Other" and sex offense had the lowest average number of incidents per month. This signifies that homicides in PG county were way lower than assault and shootings. I have questions about the differences between the averages in breaking and entering since it is quite significant.
...
Commercal B&E's, commercial robberies and assault shootings saw the greatest increases by August with up to a 50% increase. Overall, auto theft, robbery (vehicles and others) and sex offenses increased. Assault as a whole decreased but assault with a weapon slightly increased. Crimes related to properties like residential B&E's decreased. This trend showed that some but not all crimes were increasing during the summer, like violent crime saw mixed trends for example.
...
The highest number of crimes that occurred each month within PG County in 2024 were accidents.

There were 443 average incidents per month with auto's stolen being the second highest category with a monthly average of 364 and auto theft in third with 354. Overall, auto related incidents were the most common in 2024 and homicide and residential robberies had the lowest averages each month.
