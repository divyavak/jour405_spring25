...
ANSWER HERE
Median age and income are pretty correlated with voter turnout since as those increase, voter turnout does as well. Education also has a pretty strong relationship with voter turnout but we do not see that same relationship with population as the plots are a bit more scattered. 
...
ANSWER HERE
This model is actually very useful since it allows us to analyze the factors that have the highest correlations to understand which variables are useful and some of the ones like population which seem to be more insigficant.
...
ANSWER HERE
By removing some of these variables like income or education, the adjusted r value also gets impacted significantly. When those two factors got removed, the r value went down significantly. Median age can also get used after those two are removed as well. 
...
ANSWER HERE
We can make predictions on anticipated voter turnout based on our understanding of the factors of communities that play major roles in impacting voter turnout. For example, communities with higher income and high median ages typically have higher voter turnouts. 