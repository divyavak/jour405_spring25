...
Many of the detailees do not get paid while WH employees all get paid. Some of the salary values that will cause problems are the vast differences in pay since some are making no money while others are making a significant amount which is a major disparity.
...
The maximum salary is 251,258 and the minimum is 0. The outliers are 0 and 251,258 as well since no one else earns that high and a few do not earn a salary. The mean and median tell us that most people are making around \$107,036 in the White House.

### Task 7: Story Idea

Based on the data, what is your best story idea? What is the next step you would take to develop that story idea?

A story could be covering the disparities between WH employees and detailees as well as the jobs that typically see higher salaries and the difference in committments that those individuals have.
