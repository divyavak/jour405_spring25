...
The voter category that shows the biggest difference between weighted and unweighted results is the rarely/never category because when answering yes, there is a 3.6% decrease between the unweighted results and the weighted. 
2. How might these differences affect reporting on likely voter turnout?
It might lead to the rarely.never category being underepresented. 
...
They're less likely to answer the survey in the rarely/never category.