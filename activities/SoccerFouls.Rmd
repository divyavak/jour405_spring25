...
The results show that there is not a clear correlation calculation as there is no clear line of best fit. The coefficient is such a small number that it is clear there is no signifcant correlation between goal differentiation and fouls. 
