...
The results change slightly when the sample size is smaller because even if there is less people to test between sample sizes, it is representative so the results are similar. 
