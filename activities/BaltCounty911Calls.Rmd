...
ANSWER HERE
If there is less than 5 or more than 15 calls, it could be considered unusual and that is where I would draw the lines. 
...
ANSWER HERE
Unusually high on this is considered 11 and unusually low is considered 7. My answer from task 3 highlighted 15 as unusually high and 5 as unusually low. 
...
ANSWER HERE
Saturday has more than the average calls for overdoses in Baltimore County compared to all other days of the week. 
...
ANSWER HERE
Some potential angles I would take are the days drug usage is higher and where the overdose calls are coming from, if there are certain areas which are having higher overdose rates and calls than others. Also it would be important to investigate what type of drugs are being accessed and which ones are specifically causing more overdoses. 
